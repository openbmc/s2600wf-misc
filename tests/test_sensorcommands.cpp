...
TEST(sensorutils, TranslateToIPMI) {
  /*bool GetSensorAttributes(double maxValue, double minValue, int16_t &mValue,
  ...
  scaledVal =
      ipmi::ScaleIPMIValueFromDouble(0x50, mValue, rExp, bValue, bExp, bSigned);
  ...
  scaledVal =
      ipmi::ScaleIPMIValueFromDouble(12.2, mValue, rExp, bValue, bExp, bSigned);
